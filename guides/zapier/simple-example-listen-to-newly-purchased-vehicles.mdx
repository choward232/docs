...
<Steps>
  <Step title="Create a Zap">
    ...
    <Frame>
        <img src='../../images/zapier/simple-example/zapier1.png' />
    </Frame>
  </Step>
  <Step title="Sign In">
    On the account section, click ‘Sign In’.
    <Frame>
        <img src='../../images/zapier/simple-example/zapier2.png' />
    </Frame>
  </Step>
  <Step title="Fill in the credentials">
    ...
    <Frame>
        <img src='../../images/zapier/simple-example/zapier3.png' />
    </Frame>
  </Step>
  <Step title="Test the trigger">
    ...
    <Frame>
        <img src='../../images/zapier/simple-example/zapier4.png' />
    </Frame>
  </Step>
