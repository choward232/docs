...
**Important note:** the selections will vary based upon the payment selection, registration state, and vehicle type. The screenshot below shows an exhaustive list, but in reality the buyer will see only the applicable options. See more details below.
...
Ekho will assist the buyer with titling and registration by mailing the necessary documents on Ekho's end. It will be the responsibility of the buyer to pay necessary sales tax and registration fees when visiting the DMV.
