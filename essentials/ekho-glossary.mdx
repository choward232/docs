...
The selection chosen at Ekho Checkout indicating whether they would like end delivery to a specified address or pick up at pre-defined pick up locations provided by the OEM.
