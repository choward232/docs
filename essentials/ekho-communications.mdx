...
-   **Context:** Email sent when a buyer places a preorder on Ekho.
    <div
    	style={{
    		display: 'flex',
...
-   **Context:** Email sent when an OEM refunds a preorder.
...
-   **Context:** Email sent to a buyer when converting a preorder.
